...
async function rzrPremium(e){
    e.preventDefault();
    const response = await axios.get('http://${process.env.IP_ADDRESS}:3000/purchase/premiummembership', {headers: {"Authorization": token} });
    ...
    const options = {
        ...
        "handler": async function(response){
            ...
            try{
                await axios.post('http://${process.env.IP_ADDRESS}:3000/purchase/updatetransactionstatus', { 
